...
class EPICalculator:
    ...
    def compute_epi(
        self, scores: EPIScores, include_sentiment: bool = False
    ...
    def optimize_for_golden_ratio(
        self, target_epi: float, current_ethics: float, violations: List[float]
    ) -> Dict[str, Any]:
        """
...
if __name__ == "__main__":
    ...
    optimization = calc.optimize_for_golden_ratio(
        target_epi=0.75, current_ethics=0.7, violations=[]
    )
